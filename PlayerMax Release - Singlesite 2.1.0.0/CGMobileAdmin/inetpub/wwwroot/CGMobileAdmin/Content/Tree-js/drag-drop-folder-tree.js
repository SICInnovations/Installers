...
function JSDragDropTree() {
    ...
    this.imageFolder = 'Content/Tree-Images/';
    ...
    this.RENAME_STATE_BEGIN = 0;
    this.RENAME_STATE_CANCELED = 0;
    this.RENAME_STATE_REQUEST_SENDED = 0;
    ...
    */
    ...
    moveDragableNodes: function (e) {
        ...
        if (thisObj && thisObj.id) {
            ...
            JSTreeObj.dropTargetIndicator.style.left = (dragDrop_x)  + 'px';
            JSTreeObj.dropTargetIndicator.style.top = (dragDrop_y)  + 'px';
            tmpObj.style.top = (JSTreeObj.getTopPos(dragDrop_y) + JSTreeObj.indicator_offsetY) + 'px';
        }
