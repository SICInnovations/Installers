        ...
        <ContentTemplate>
                        ...
                        <div class="col-md-12 clearfix">
                            <div class="tabControls">
                                <ul class="nav nav-tabs">                 
                                     <li class="active col-xsm-32 nav-tabs-content"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#manageContentTab" onclick="SetSelectedTab('contentTab')">Event Details</a></li>
                                    <li class="col-xsm-32  nav-tabs-schedule"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#manageScheduleTab" id="manageScheduleTabLink" onclick="SetSelectedTab('scheduleTab')">Schedule</a></li>
            ...
            $('input:checkbox[id*="chkReferPopulationListAllPlayers"]').on('change', function () {
                ...
                function SetDefaultTab() {
                    ...
                    $('#referFriendEventTab').addClass('active');
                }
