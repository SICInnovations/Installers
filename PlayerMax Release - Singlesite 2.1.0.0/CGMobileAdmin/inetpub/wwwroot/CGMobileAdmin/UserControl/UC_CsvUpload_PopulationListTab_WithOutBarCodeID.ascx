<%@ Control Language="C#" AutoEventWireup="true" ValidateRequestMode="Disabled" CodeBehind="UC_CsvUpload_PopulationListTab_WithOutBarCodeID.ascx.cs" Inherits="HAMobileWebAdmin.UC_CsvUpload_PopulationListTab_WithOutBarCodeID" %>
<div class="clearfix tab-container">
    <div class="col-md-12">
        <div class="fieldset">
                        ...
                        <div class="col-md-6 model2 row">
                            <div>
                                ...
                                <div class="UploadDiv uploadcsv">
                                    ...
                                    <button type="button" onclick="return false;" id="btnCsvFileUploadWithBarCodeID" class="UploadButtonWihtoutBarcodeID"></button>
                                    <div id="UploadedFile">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group model-file-uploaders model-file-uploadersWithoutBarCodeID1">
                                        <asp:TextBox ID="txtValidRecords" ReadOnly="true" Text="0" runat="server" class="form-control"></asp:TextBox>
                                        <span class="input-group-addon" data-toggle="modal" href="#validRecordsModalWithoutBarCodeID"><i class="glyphicon glyphicon-eye-open"></i></span>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Invalid Records</label>
                                    <div class="input-group model-file-uploaders model-file-uploadersWithoutBarCodeID2">
                                        <asp:TextBox ID="txtInvalidRecords" Text="0" ReadOnly="true" runat="server" class="form-control"></asp:TextBox>
                                        <span class="input-group-addon" data-toggle="modal" href="#invalidRecordsModalWithoutBarCodeID"><i class="glyphicon glyphicon-eye-open"></i></span>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Records in List</label>
                                    <div class="input-group model-file-uploaders model-file-uploadersWithoutBarCodeID3">
                                        <asp:TextBox ID="txtTotalRecords" Text="0" runat="server" ReadOnly="true" class="form-control"></asp:TextBox>
                                        <span class="input-group-addon" data-toggle="modal" href="#totalRecordsModalWithoutBarCodeID"><i class="glyphicon glyphicon-eye-open"></i></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="validRecordsModalWithoutBarCodeID" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
                        ...
                        <div class="modal-body">
                            <div class="modal-body-inner">
                                <div class="data-table-wrapper">
                                    <table class="table data-table" id="data-tableWithoutBarCodeID1">
                                        <thead>
                                            <tr>
                                                <td>&nbsp;</td>
                                            </tr>
            ...
            <div class="modal fade" id="invalidRecordsModalWithoutBarCodeID" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                        ...
                        <div class="modal-body">
                            <div class="modal-body-inner">
                                <div class="data-table-wrapper">
                                    <table class="table data-table" id="data-tableWithoutBarCodeID2">
                                        <thead>
                                            <tr>
                                                <td>&nbsp;</td>
                                            </tr>
            ...
            <div class="modal fade" id="totalRecordsModalWithoutBarCodeID" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                        ...
                        <div class="modal-body">
                            <div class="modal-body-inner">
                                <div class="data-table-wrapper">
                                    <table class="table data-table" id="data-tableWithoutBarCodeID3">
                                        <thead>
                                            <tr>
                                                <td>&nbsp;</td>
                                            </tr>
