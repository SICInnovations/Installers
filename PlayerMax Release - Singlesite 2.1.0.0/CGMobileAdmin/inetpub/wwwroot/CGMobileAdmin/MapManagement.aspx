...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:UpdatePanel ID="updpnlContentDetail" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
                    ...
                    <div class="filterWrapper relative" id="dvLeftcontentdetail">
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="lnkBtnShowContentDetail" runat="server" Text='<%#Eval("Name") %>' CommandName="Select" OnClick="lnkBtnShowMapDetail_Click" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                        ...
                        <div class="filterResults relative btnGroup filterResults3" id="dvLeftContent">
                            <div class="btn-groupSpecial">
                                <asp:Button ID="lnkbtnActive" runat="server" Text="Active" OnClick="lnkbtnActive_Click" OnClientClick="setActive('Active'); return MapValidationAlert(4);" CssClass="results-control col-xs-4 active"></asp:Button>
                                <asp:Button ID="lnkbtnInActive" runat="server" Text="InActive" OnClick="lnkbtnInActive_Click" OnClientClick="setActive('InActive'); return MapValidationAlert(5);" CssClass="results-control col-xs-4"></asp:Button>
                                <asp:Button ID="lnkbtnInAll" runat="server" Text="All" OnClick="lnkbtnAll_Click" CssClass="results-control col-xs-4" OnClientClick="setActive('All'); return MapValidationAlert(6);"></asp:Button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12 clearfix">
                            <div class="tabControls">
                                <ul class="nav nav-tabs">
                                    <li class="active col-xsm-32 nav-tabs-map"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#mapDetailsTab" onclick="SetSelectedTab('Map');">Map Details</a></li>
                                    <li class="col-xsm-32 nav-tabs-machine"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#machineDetailsTab" onclick="SetSelectedTab('Machine');">Machine details</a></li>
                                    <li class="col-xsm-32 nav-tabs-inventory"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#slotInventoryDataTab" onclick="SetSelectedTab('Inventory');">Slot Inventory Data</a></li>
                                </ul>
            ...
            <asp:HiddenField runat="server" ID="hdnSeletedTab" Value="Map" />
