...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="tblcontent form-horizontal mt20">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <asp:TextBox ID="txtPlayerClubID" runat="server" MaxLength="50" CssClass="form-control fmcontrol numeric"></asp:TextBox>
            </div>
        </div>
        <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-12 icons-control-btn clearfix">
                ...
                <asp:Button ID="btnconfirm" runat="server" OnClientClick="return formValidation();" CssClass="btn btn-icon-save pull-right btn-gray" Text="CONFIRM" OnClick="btnconfirm_Click" />
