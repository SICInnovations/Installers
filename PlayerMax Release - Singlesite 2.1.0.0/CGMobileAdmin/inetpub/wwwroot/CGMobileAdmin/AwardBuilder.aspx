                ...
                <div class="col-md-3">
                    ...
                    <div class="filterWrapper relative" id="dvLeftcontentdetail">
                        ...
                        <div class="new-select">
                            <asp:DropDownList ID="ddlAwardTypeFilter" AutoPostBack="true" runat="server" CssClass="form-control jq-selectbox" OnSelectedIndexChanged="ddlAwardTypeFilter_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        <div id="divgv">
                            ...
                            <asp:GridView CssClass="gridview" ID="gvAwardBuilder" runat="server" ShowHeader="False" AutoGenerateColumns="false"
                                DataKeyNames="AwardID" AllowPaging="true" PageSize="10"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="lnkBtnAwardName" runat="server" Text='<%#Eval("AwardName") %>' OnClick="lnkBtnAwardName_Click" />
                    ...
                    <div class="row clearfix relative btnGroup btnGroup3" id="dvRightContent">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlAwardType" runat="server" CssClass="form-control"></asp:DropDownList>
