<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ManageBatchMessage.aspx.cs" Inherits="HAMobileWebAdmin.ManageBatchMessage" ValidateRequest="false" EnableEventValidation="false"%>
               ...
               <asp:HiddenField runat="server" ID="hdnBatchMessagePopulationID" Value="" />
                ...
                <div class="col-sm-3">
                    ...
                    <div class="filterWrapper relative" id="dvLeftcontentdetail1">
                        ...
                        <div id="divgv">
                            <asp:GridView CssClass="gridview" ID="gvBatchMessage" runat="server" DataKeyNames="BatchMessageID" PageSize="13"
                        ...
                        <div class="col-md-12 clearfix">
                            <div class="tabControls">
                                <ul class="nav nav-tabs">
                                    <li class="active col-xsm-32 nav-tabs-content"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#manageContentTab" onclick="SetSelectedTab('contentTab')">Message Content</a></li>
                                    <li class="col-xsm-32  nav-tabs-schedule"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#manageScheduleTab" id="manageScheduleTabLink" onclick="SetSelectedTab('scheduleTab')">Message Schedule</a></li>
                                    <li class="col-xsm-32  nav-tabs-population"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#managePopulationTab" id="managePopulationTabLink" onclick="SetSelectedTab('populationTab')">Population</a></li>
                                </ul>
                                            ...
                                            <div class="col-md-12 html-editor-spacing">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <asp:TextBox ID="txtMessageForm" class="form-control" runat="server"  MaxLength="250"/>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="event_triger col-md-12" >
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                ...
                                                                <asp:DropDownList runat="server" OnSelectedIndexChanged="ddlTriggerType_SelectedIndexChanged" ID="ddlTriggerType" CssClass="form-control jq-selectbox">
                                                                </asp:DropDownList>
                                                            </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="input-group date datePickers" data-date-format="mm-dd-yyyy">
                                                                                <asp:TextBox ID="TextBox1" runat="server" class="form-control datePickers"></asp:TextBox>
<%--                                                                                <asp:TextBox ID="txtDateTimeTriggerDate" Visible="false" runat="server" class="form-control datePickers"></asp:TextBox>--%>
                               <%--                                                 <asp:TextBox runat="server" ID="txtDateTimeTriggerDate" Visible="false" class="form-control datePickers"></asp:TextBox>--%>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label>At</label>
                                                                        <div class="bootstrap-timepicker input-group">
                                                                            <asp:TextBox ID="TextBox2" runat="server" class="form-control timePickers"></asp:TextBox>
         <%--                                                                   <asp:TextBox ID="txtDateTimeTriggerTime" runat="server" class="form-control timePickers"></asp:TextBox>--%>
<%--                                                                            <asp:TextBox runat="server" ID="txtDateTimeTriggerTime" Visible="false" class="form-control timePickers"></asp:TextBox>--%>
                ...
                function GetGeofence()
                {
                    ...
                    if ($('#<%=hdnBatchMessageID.ClientID%>').val() != '' &&  $('#<%=hdnDectedGeofenceChange.ClientID%>').val()==0) {
                        ...
                        $.ajax({
                            ...
                            data: "{messageID: " + messageId + ",messageSender:'" + messageSender + "',status:" + status + "}",
