...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="HeadContent">
    ...
    <style type="text/css">
        .txtGlobalAssetMessageBGColor .simpleColorDisplay {
            margin-top: -39px;
        }
    </style>
</asp:Content>
        ...
        <ContentTemplate>
            <div class="row" id="slotInventory">
                    ...
                    <div class="filterWrapper relative" id="dvLeftcontentdetail">
                        ...
                        <div class="filterResults relative btnGroup">
                            <div class="btn-groupSpecial">
                                <asp:Button ID="lnkbtnActive" runat="server" Text="Active" OnClick="lnkbtnActive_Click" CssClass="results-control col-xs-4 active"></asp:Button>
                                <asp:Button ID="lnkbtnInActive" runat="server" Text="InActive" OnClick="lnkbtnInActive_Click" CssClass="results-control col-xs-4"></asp:Button>
                                <asp:Button ID="lnkbtnAll" runat="server" Text="All" OnClick="lnkbtnAll_Click" CssClass="results-control col-xs-4"></asp:Button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-9">
                    ...
                    <asp:HiddenField runat="server" ID="hdnImageFileId5" />
                    <asp:HiddenField runat="server" ID="hdnImageFileId6" />
                    ...
                    <asp:HiddenField runat="server" ID="hdnAwardID5" />
                    <asp:HiddenField runat="server" ID="hdnAwardID6" />
                        ...
                        <div class="col-md-12 clearfix">
                            <div class="tabControls">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="col-xsm-25 nav-tabs-content"><span class="linkDisabledsp">&nbsp;</span><a onclick="SetSelectedTab('content');" data-toggle="tab" href="#manageContentTab" id="manageContentTabLink">Content</a></li>
                                    <li class="col-xsm-25 linkDisabled nav-tabs-schedule"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" onclick="SetSelectedTab('schedule');" href="#manageScheduleTab" id="manageScheduleTabLink">Schedule</a></li>
                                    <li class="col-xsm-25 linkDisabled nav-tabs-population"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" onclick="SetSelectedTab('populationTab');" href="#managePopulationTab" id="managePopulationTabLink">Population</a></li>
                                </ul>
                                <div class="tab-content">
                                        ...
                                        <div class="tab-container clearfix">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row" id="dvAllProperties">
                                                    <div class="col-md-4 top-margin-one">
                                                        <asp:CheckBox ID="chkAllProperties" Text="All Properties" AutoPostBack="true" ClientIDMode="Static" OnCheckedChanged="chkAllProperties_CheckedChanged" Visible="True" runat="server" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane active fade in" id="manageContentTab">
                                        ...
                                        <div id="dvSplashScreen" class="hello" style="display: none;">
                                            <div class="tab-container clearfix">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 imageview">
                                                            ...
                                                            <img:UploadImage runat="server" ID="UploadSplashScreenImage" />
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5 three-column">
                                                            <label for="WebAppBranding_lblImage1">
                                                                Upper Left Image
                                                                <br />
                                                                (Upload Image 230x80 Pixels)</label>
                                                        ...
                                                        <div class="col-md-5 three-column">
                                                            <label for="WebAppBranding_lblImage2">
                                                                Top/Right Image
                                                                <br />
                                                                (Upload Image 1345x80 Pixels)</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5 three-column">
                                                            <label for="WebAppBranding_lblImage3">
                                                                Bottom Left Image
                                                                <br />
                                                                (Upload Image 230x459 Pixels)</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5 three-column">
                                                            <label for="lblWebAppLoginScreenBrandingmage1">
                                                                Upper Left Image
                                                                <br />
                                                                (Upload Image 339x150 Pixels)</label>
                                                        ...
                                                        <div class="col-md-5 three-column">
                                                            <label for="lblWebAppLoginScreenBrandingImage2">
                                                                Left Image
                                                                <br />
                                                                (Upload Image 1023x974 Pixels)</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-5 three-column">
                                                            <label for="lblWebAppBrandingImage3">
                                                                Right Image
                                                                <br />
                                                                (Upload Image 339x974 Pixels)</label>
                                                        ...
                                                        <div class="col-md-5 three-column">
                                                            <label for="UploadMyRewardImageImage2">
                                                                GIFT POINT Image
                                                                 <br />
                                                                (Upload Image 140x140 Pixels)</label>
                                                            <img:UploadImage runat="server" ID="UploadMyGiftPointImage" />
                                                        </div>
                                        ...
                                        <div id="dvRewardAssest" class="hello" style="display: none;">
                                            <div class="tab-container clearfix">
                                                <div class="col-md-12">
                                                    ...
                                                    <div>
                                                        <div class="row">
                                                            <div class="col-md-5 three-column">
                                                                <label for="UploadMyRewardImageImage3">
                                                                    My Reward Header Image
                                                                    <br />
                                                                    (Upload Image 636x396 Pixels)</label>
                                                                <img:UploadImage runat="server" ID="UploadMyRewardHeaderImg" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            ...
                                                            <ol>
                                                                ...
                                                                <li>@ReferreePoint = To show points of Referree for referral in referral message</li>
                                                            </ol>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4" style="margin-top: 250px;">
                                                            <label class="label">Message Inbox Search Bar Background Color</label>
                                                            <div class="row clearfix">
                                                                <div class="col-md-8 txtGlobalAssetMessageBGColor">
                                                                    <asp:TextBox ID="txtGlobalAssetMessageBGColor" onchange="isValidColor(this)" runat="server" CssClass="form-control simple_color_color_code" MaxLength="15"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <asp:TextBox ID="txtTableGamesDetailXpos"  class="form-control numericwithdecimal" onKeyPress="NumberOnly(event);" runat="server" MaxLength="15" />
                                                        </div>

                                                        <div class="col-md-4">
                                                            <label for="mapY">Y-Pos</label>
                                                            <asp:TextBox ID="txtTableGamesDetailYpos" class="form-control numericwithdecimal" onKeyPress="NumberOnly(event);" runat="server" MaxLength="15" />
                                                        </div>
...
<%--                                                    <div class="row">
                                        ...
                                        <%--HS-1 Lodging Support, NAcupido, 1/22/2018 ////////////////////////////////////////////////////////////////////////////////////////--%>
...
<%--                                                            <div class="col-md-12">
                                        ...
                                        <div id="dvClientBranding" class="hello" style="display: none;">
                                            <div class="tab-container clearfix">
                                                ...
                                                <div class="col-md-4">
                                                    <label for="lblBackgroundNavigationBar">
                                                    ...
                                                    <label for="lblBackgroundNavigationBarRatina">
                                                        Background Navigation Bar - Ratina
                                                        <br>
                                        ...
                                        <div class="tab-container clearfix">
                                            ...
                                            <asp:Panel ID="pnlSchedule" runat="server">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="txtScheduleName" runat="server" CssClass="form-control" MaxLength="250" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-4">
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="col-xs-6">
                                                                <div class="clearfix calTime">
                                                                    ...
                                                                    <div class="col-xs-9">
                                                                        <div class="input-group date datePickers" data-date-format="mm/dd/yyyy">
                                                                            <asp:TextBox ID="txtScheduleFrom" runat="server" class="form-control datePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                ...
                                                                <div class="clearfix calTime">
                                                                    ...
                                                                    <div class="col-xs-9">
                                                                        <div class="input-group date datePickers" data-date-format="mm/dd/yyyy">
                                                                            <asp:TextBox ID="txtScheduleTo" runat="server" class="form-control datePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                            ...
                                                            <div class="col-xs-6">
                                                                <div class="clearfix calTime">
                                                                    ...
                                                                    <div class="col-xs-9">
                                                                        ...
                                                                        <div class="input-group bootstrap-timepicker">
                                                                            <asp:TextBox ID="txtScheduleFromAt" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                ...
                                                                <div class="clearfix calTime">
                                                                    ...
                                                                    <div class="col-xs-9">
                                                                        <div class="bootstrap-timepicker input-group">
                                                                            <asp:TextBox ID="txtscheduleToAt" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                            <i class="icon-time"></i>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <tbody>
                                                                    <tr class="trmonday">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleMondayFrom" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleMondayTo" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr class="trtuesday">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleTueFrom" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleTueTo" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr class="trwednesday">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleWedFrom" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleWedTo" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr class="trthursday">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleThuFrom" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleThuTo" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr class="trfriday">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleFriFrom" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleFriTo" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr class="trsaturday">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleSatFrom" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleSatTo" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr class="trsunday">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleSunFrom" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="pull-left" style="margin-left: 15px;">
                                                                                <div class="bootstrap-timepicker input-group">
                                                                                    <asp:TextBox ID="txtScheduleSunTo" runat="server" class="form-control timePickers" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                                                                    <i class="icon-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </td>
            ...
            <script type="text/javascript">
                ...
                function RegisterleftDivheigth() {
                ...
                function UploadControlHandler(control, ImageUrlHf, ImageUrlImg, ImageSetUrlImg) {
                    new AjaxUpload('#' + $(control).prop('id') + '', {
                        ...
                        onComplete: function (file, response) {
                            ...
                            var img = new Image();
                            img.src = res[2];
                            //var Imgwebbranding = null;
                            //For Start Screen Assets/Signup Assets/Promotion Assets/Global Assets/Splash Screen Assets
                            if (contentTypeId == 1 || contentTypeId == 2 || contentTypeId == 3 || contentTypeId == 22 || contentTypeId == 47) {
                                height = 1008;
                                width = 640;
                            }
                                //For Pramotions
                                ...
                                //My Reward Image(44)/Reward Assets(33)
                            else if (contentTypeId == 44) {
                                height = 140;
                                width = 140;
                            }
                                //Web App Branding(25)
                            else if (contentTypeId == 25 && $(control).prop('id') == 'MainContent_UploadWebAppBrandingImage1_btnCsvFileUpload')
                            {
                              height = 80;
                              width = 230;
                            }
                            else if (contentTypeId == 25 && $(control).prop('id') == 'MainContent_UploadWebAppBrandingImage2_btnCsvFileUpload')
                            {
                                height = 80;
                                width = 1345;
                            }
                            else if (contentTypeId == 25 && $(control).prop('id') == 'MainContent_UploadWebAppBrandingImage3_btnCsvFileUpload') {
                                height = 459;
                                width = 230;
                            }

                                //Web App login Screen Branding(24)
                            else if (contentTypeId == 24 && $(control).prop('id') == 'MainContent_UploadWebAppLoginScreenBrandingImage1_btnCsvFileUpload') {
                                height = 150;
                                width = 339;
                            }
                            else if (contentTypeId == 24 && $(control).prop('id') == 'MainContent_UploadWebAppLoginScreenBrandingImage2_btnCsvFileUpload') {
                                height = 974;
                                width = 1023;
                            }
                            else if (contentTypeId == 24 && $(control).prop('id') == 'MainContent_UploadWebAppLoginScreenBrandingImage3_btnCsvFileUpload') {
                                height = 974;
                                width = 339;
                            }
                            ...
                            setTimeout(function () {
                                if (contentTypeId == 25)
                                {
                                    if (img.width > width) {
                                       ...
                                       document.getElementById('<%=alertMessage.ClientID%>').innerHTML = 'File width should not less than ' + width + '.';
                                            $('#AlertBox').modal({ backdrop: 'static', keyboard: false });
                                        }
                                    ...
                                    document.getElementById('<%=alertMessage.ClientID%>').innerHTML = 'File height should not less than ' + height + '.';
                                        $('#AlertBox').modal({ backdrop: 'static', keyboard: false });
                                    }
                                ...
                                else if (contentTypeId == 23) {
                                    $('#' + ImageUrlHf).val(response);
                                    $('#' + ImageUrlImg).attr('src', res[2]);
                                    $('#' + ImageSetUrlImg).val(res[2]);
                                }
                                if (contentTypeId != 23 && contentTypeId != 25 && contentTypeId != 24) {
                                    if (img.width > width) {
                                        document.getElementById('<%=alertMessage.ClientID%>').innerHTML = 'File width should not exceed ' + width + '.';
                                    $('#AlertBox').modal({ backdrop: 'static', keyboard: false });
                                }
                ...
                function RegisterContentTypeTab() {
                    ...
                    switch (contentTypeId) {
                        ...
                        case ContentTypeConstants.RewardAssets:
                            $('.hello').hide();
                            $('#dvRewardAssest').fadeIn(1000, function () {
                                $('#manageScheduleTabLink, #managePopulationTabLink').parent().removeClass('linkDisabled');
                                if (document.getElementById('<%=hdnIsPopulation.ClientID%>').value == 'False')
                                    $('#managePopulationTabLink').parent().addClass('linkDisabled');
                                if (document.getElementById('<%=hdnIsShedule.ClientID%>').value == 'False')
                        ...
                        case ContentTypeConstants.SignupAssets:
                            ...
                            break;
                        case '47':  // splash screen asset
                            $('.hello').hide();
                            $('#dvSplashScreen').fadeIn(1000, function () {
                                $('#manageScheduleTabLink, #managePopulationTabLink').parent().removeClass('linkDisabled');
                                if (document.getElementById('<%=hdnIsPopulation.ClientID%>').value == 'False')
                                        $('#managePopulationTabLink').parent().addClass('linkDisabled');
                                    if (document.getElementById('<%=hdnIsShedule.ClientID%>').value == 'False')
                    ...
                    function FormValidation() {
                        ...
                        if (document.getElementById('<%=ddlContentType.ClientID%>') != null && document.getElementById('<%=ddlContentType.ClientID%>').selectedIndex != -1) {
                            ...
                            //To check property.
                            if ($("#<%= chkAllProperties.ClientID %>").prop("checked") == false && $("#<%= hdnSelectedProperties.ClientID %>").val() == "") {
                                document.getElementById('<%=alertMessage.ClientID%>').innerHTML = 'Please select at least one property';
                                $('#AlertBox').modal({ backdrop: 'static', keyboard: false });
                ...
                function ConfirmMessage(flag) {
                    ...
                    var deletemsg = 'Are you sure you want to delete this content?';
...
//////****************************End Common Function Part *************************************************************
            ...
            <script type="text/javascript">
                ...
                function RefreshSlotType() {
                    var selectlistid = $("[id*=ddlDashboardMostPopularSlotDetailType]");
                    var obj = {};
                    obj.properties = $.trim($("[id*=hdnSelectedProperties]").val());
                    obj.IsAllProp = $("#chkAllProperties").attr("checked") ? 1 : 0;
                    $.ajax({
                        type: "POST",
                        url: "ManageContent.aspx/BindSType",
                        ...
                        success: function (data) {
                            $.each(data, function () {
                                ...
                                for (var i = 0; i < data.d.length; i++) {
                                        options += '<option value="' + data.d[i].ContentDetailID + '" selected>' + data.d[i].PlainText1 + '</option>';
                                }
                                $(selectlistid).html(options);
                            });
                        }
                    });
                }
