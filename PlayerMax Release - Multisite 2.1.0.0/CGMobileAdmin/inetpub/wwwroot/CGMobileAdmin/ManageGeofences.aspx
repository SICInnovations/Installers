...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="Scripts/CommonJS/perfect-scrollbar.js"></script>
         <%-- <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=drawing,geometry,places&key=AIzaSyCdx4cE2psxmVQevwoAaMQ5NTH40FNjiEU"></script>--%>
           <%--<script src="Scripts/GeoFence%20JS/CreateRedius_Polygon.js"></script>
          <script src="Scripts/GeoFence%20JS/ShowRedius_Polygon.js"></script>--%>
    <style type="text/css"> 
        .infomsg {
            display:none;
        }
    ...
    <asp:UpdatePanel ID="updpnlContentDetail" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <div class="filterWrapper relative" id="dvLeftcontentdetail">
                        ...
                        <div id="divgv">
                            <asp:GridView CssClass="gridview" ID="gvGeofences" runat="server" ShowHeader="False" AutoGenerateColumns="false" DataKeyNames="GeofenceID" AllowPaging="true" PageSize="15" OnPageIndexChanging="gvGeofences_PageIndexChanging">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                    ...
                    <div class="row clearfix relative btnGroup btnGroup3" id="dvRightContent">
                        <div class="col-md-12 clearfix">
                            <div class="tabControls">
                                ...
                                <li class="col-xsm-50 nav-tabs-content active"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#manageGeoFenceTab" id="manageGeoFenceTabLink" onclick="SetSelectedTab('contentTab')">Geofence Details</a></li>
                                </ul>
                                        ...
                                        <div class="tab-container clearfix">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row" id="dvAllProperties">
                                                    <div class="col-md-4 top-margin-one">
                                                        <asp:CheckBox ID="chkAllProperties" Text="All Properties" AutoPostBack="false" ClientIDMode="Static" OnClick="JavaScript:DisableAndResetListBox()" Visible="True" runat="server" />
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane active fade in" id="manageGeoFenceTab">
                                        <div class="tab-container clearfix">
                                                                ...
                                                                <div class="controle-search-map-geo">
                                                                    ...
                                                                    <div class="col-md-3 col-sm-4 col-xs-5 pd0">
                                                                        <div class="ctrl_btns wd100">
                                                                            <div class="col-md-2 col-sm-2 col-xs-2 pd0 searchbtn" style="display:none" >
                                                                            ...
                                                                            <div class="col-md-10 col-sm-10 col-xs-10 pd0">
                                                                                <button type="button" class="btn clear" onclick="DeleteField(); ClearField();" title="Clear map lat and long">Clear Geofence</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
            ...
            <script type="text/javascript">
                ...
                function ClearField() {
                    $('#<%=txtSearchLatLongMap.ClientID%>').val('');
                }
    ...
    $('#<%=btnConfirmedSave.ClientID%>').hide();
            ...
            <%--We are faceing key issue now for this instance i just created one key after that its working fine--%>
   <%-- <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=drawing,geometry,places&key=AIzaSyCdx4cE2psxmVQevwoAaMQ5NTH40FNjiEU"></script>--%>
            ...
            <script type="text/javascript">
                ...
                function SetTabControls() {
                    ...
                    var rowscount = $("#<%=gvGeofences.ClientID %> tr").length;
                    ...
                    switch (readTabValue) {
                        ...
                        case 'contentTab':
                            ...
                            $('.tab-content .tab-pane').removeClass('active in');
                            $('#manageGeoFenceTab').addClass('active in');
                            SetMapDrawingType();
                            RegisterleftDivheight();
