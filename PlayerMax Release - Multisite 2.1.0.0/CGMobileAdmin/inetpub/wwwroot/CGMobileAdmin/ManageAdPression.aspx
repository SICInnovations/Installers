<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ManageAdPression.aspx.cs" Inherits="HAMobileWebAdmin.ManageAdPression" ValidateRequest="false" %>
                            ...
                            <div class="tabControls">
                                <div class="tab-pane">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="active col-xsm-25 nav-tabs-content"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#adPressionEventTab" id="manageContentTabLink" onclick="SetSelectedTab('contentTab')">Event Details</a></li>
                                        <li class="col-xsm-25  nav-tabs-schedule"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#adPressionScheduleTab" id="manageScheduleTabLink" onclick="SetSelectedTab('scheduleTab')">Schedule</a></li>
                                        <li class="col-xsm-25  nav-tabs-population"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#adPressionPopulationTab" id="managePopulationTabLink" onclick="SetSelectedTab('populationTab')">Population</a></li>
                                    </ul>
                ...
                function SetActiveTab()
                {
                    ...
                    switch (activeTab) {
                        case 'propertyTab':
                            ...
                            $('.nav-tabs li.nav-tabs-content').addClass('active');
                            $('.tab-content .tab-pane').removeClass('active in');
                            $('#managePropertyTab').addClass('active in');
                            break;
                        case 'contentTab':
                            $('.nav-tabs li').removeClass('active');
                            $('.nav-tabs li.nav-tabs-content').addClass('active');
