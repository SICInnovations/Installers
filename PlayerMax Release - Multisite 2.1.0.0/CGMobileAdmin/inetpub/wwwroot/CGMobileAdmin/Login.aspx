...
<body class="login">
    <form id="form1" runat="server">
        ...
        <asp:HiddenField runat="server" ID="hdnImageFileId3" />
         <asp:HiddenField ID="hidWorkstationName" runat="server"/>
         <asp:HiddenField ID="hidIpAddress" runat="server" />
      <%--  <header>
            <div>
   ...
   <script type="text/javascript">
    ...
    var lblThemeText = $("#lblTheme").text();
           if (lblThemeText == 'Blue') {
               $("body").addClass("HA_BlueTheme");
           }
           else {
               $("body").removeClass("HA_BlueTheme");
           }
