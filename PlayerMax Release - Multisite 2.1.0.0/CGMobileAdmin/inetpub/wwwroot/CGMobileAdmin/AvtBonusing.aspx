...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <style type="text/css">
        .nav-tabs li a {
             background: url("../../Content/img/navPill.png") repeat-x;
        }
       .nav-tabs  li.active a,.nav-tabs  li a:hover, .nav-tabs  li a:focus{
            background:url("../../Content/img/navPill_active.png") repeat-x;
        }      
    </style>
</asp:Content>
            ...
            <div class="row" id="slotInventory">
                <div class="col-sm-3">
                    ...
                    <div class="filterWrapper relative" id="dvLeftcontentdetail1">
                        <div class="clearfix">
                            <div class="pull-left">
                                <label>AvT Bonusing Event</label>
                            </div>
                ...
                <div class="col-sm-9">
                    <h5>AvT Bonusing Detail </h5>
                    <div class="row clearfix relative btnGroup btnGroup3" id="dvRightContent1">
                        <div class="col-md-12 clearfix">
                            <div class="tabControls">
                                <ul class="nav nav-tabs">
                                    <li class="active col-xsm-20 nav-tabs-property"><span class="linkDisabledsp">&nbsp;</span><a onclick="SetSelectedTab('propertyTab');" data-toggle="tab" href="#propertyTab">Property</a></li>
                                    <li class="col-xsm-20 nav-tabs-content"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#manageEventDetailTab" onclick="SetSelectedTab('contentTab')">Event Details</a></li>
                                    <li class="col-xsm-20 nav-tabs-schedule"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#manageScheduleTab" id="manageScheduleTabLink" onclick="SetSelectedTab('scheduleTab')">Schedule</a></li>
                                    <li class="col-xsm-20 nav-tabs-population"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#managePopulationTab" id="managePopulationTabLink" onclick="SetSelectedTab('populationTab')">Population</a></li>
                                    <li class="col-xsm-20 nav-tabs-message"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#manageMessageTab" id="manageMessageTabLink" onclick="SetSelectedTab('MessageTab')">Message</a></li>
                                </ul>
                                        ...
                                        <div class="tab-container clearfix">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row" id="dvAllProperties">
                                                    <div class="col-md-4 top-margin-one">
                                                        <asp:CheckBox ID="chkAllProperties" Text="All Properties" AutoPostBack="true"  Visible="True" runat="server" OnCheckedChanged="chkAllProperties_CheckedChanged" />
                                                    </div>
                                                </div>
                                                <div class="row" id="dvSelectPropertiesLbl">
                                                    <div class="col-md-8 top-margin-one">
                                                        ...
                                                        <asp:ListBox ID="lstProperties" SelectionMode="Multiple" runat="server" CssClass="propertyBox"></asp:ListBox>
                                        ...
                                        <div class=" tab-container  clearfix">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row" id="dvlstTier">
                                                    ...
                                                    <asp:ListBox runat="server" ID="lstPopulationTiers" SelectionMode="Multiple" CssClass="tiersListBox"></asp:ListBox>
    ...
    For example, if the event schedule Day of Week for the current day of week is 8:00 PM, that’s the value for ScheduleDayEndTime.
            ...
            <script type="text/javascript">
                ...
                function RegisterListBox() {
                    var propertyBox = $('.propertyBox').bootstrapDualListbox({
