    ...
    <asp:UpdatePanel ID="updpnlContentDetail" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
                        ...
                        <div class="col-md-12 clearfix">
                            <div class="tabControls">
                                <ul class="nav nav-tabs">
                                    <li class="active col-xsm-25 nav-tabs-property"><span class="linkDisabledsp">&nbsp;</span><a onclick="SetSelectedTab('propertyTab');" data-toggle="tab" href="#propertyTabLink">Property</a></li>
                                    <li class="col-xsm-25 nav-tabs-content"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#manageContentTabLink" id="manageContentTab" onclick="SetSelectedTab('contentTab')">Details</a></li>
                                    <li class="col-xsm-25  nav-tabs-schedule"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#ScheduleTabLink" id="manageScheduleTab" onclick="SetSelectedTab('scheduleTab')">Schedule</a></li>
                                    <li class="col-xsm-25  nav-tabs-population"><span class="linkDisabledsp">&nbsp;</span><a data-toggle="tab" href="#PopulationTabLink" id="managePopulationTab" onclick="SetSelectedTab('populationTab')">Population</a></li>
                                </ul>
                                <div class="tab-pane">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <asp:TextBox ID="txtCasinoWithinNofDays" Visible="false" CssClass="form-control numericwithdecimal" runat="server" MaxLength="8" />
            ...
            <script type="text/javascript">
                ...
                $("#MainContent_UC_PopulationTypeTab_ddlTierType").click(function () {
                    $('#<%=hndSelectedTab.ClientID%>').val('');
